...
class Detail_Bien extends StatefulWidget {
   ...
   const Detail_Bien({Key? key, required this.bien_materiel , required this.localisation}) : super(key: key);

  final Bien_materiel bien_materiel;
  final Localisation localisation;

  @override
  _Detail_BienState createState() => _Detail_BienState(bien_materiel:this.bien_materiel,localisation:this.localisation);
}
                                      ...
                                      child:
                                       Row(
                                         children: [
                                           ...
                                           SizedBox(width: 10,),
                                           Text('Code article : ${bien_materiel.code_bar}',
                                           style: TextStyle(
                                             fontSize: 16
                                           ),
                                           ),
                                      ...
                                      child:
                                       Row(
                                         children: [
                                           ...
                                           SizedBox(width: 10,),
                                           Text('Etat : ${bien_materiel.get_state()}',
                                           style: TextStyle(
                                             fontSize: 16
                                           ),
                                           ),
                                      ...
                                      child:
                                       Row(
                                         children: [
                                           Icon(Icons.timer),
                                           SizedBox(width: 10,),
                                           Text('Date de scan : ${date_format(bien_materiel.date_scan.toString())}',
                                           style: TextStyle(
                                             fontSize: 16
                                           ),
                                           ),
                                      ...
                                      child:
                                       Row(
                                         children: [
                                           Icon(Icons.home),
                                           SizedBox(width: 10,),
                                           Text('code localité : ${bien_materiel.code_localisation}',
                                           style: TextStyle(
                                             fontSize: 16
                                           ),
                                           ),
                                         ...
                                         children: [
                                           ...
                                           TextButton.icon(
                                             ...
                                             onPressed: (){
                                                Navigator.push(
                                                context,
                                                MaterialPageRoute(builder: (context) =>  Update_Bien(bien: bien_materiel,localisation: localisation,),
                                                ),
                                              );
